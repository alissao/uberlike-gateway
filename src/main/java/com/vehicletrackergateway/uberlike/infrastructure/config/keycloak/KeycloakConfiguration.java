package com.vehicletrackergateway.uberlike.infrastructure.config.keycloak;
...
public class KeycloakConfiguration {
  ...
  @Bean
	Converter<Jwt, Collection<GrantedAuthority>> keycloakGrantedAuthoritiesConverter(@Value("${spring.application.security.clientId}") String clientId) {
